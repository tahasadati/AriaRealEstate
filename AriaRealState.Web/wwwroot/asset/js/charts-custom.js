(function () {
  ...
  if (basicLineChart) {
    var options = {
      ...
      xaxis: {
        categories: ["خرداد", "تیر", "مرداد", "شهریور", "مهر", "آبان", "آذر", "دی", "بهمن"],
        axisTicks: {
          show: false,
          color: "#ECEEF2",
        },
  ...
  if (datetimeAreaChart) {
    var options = {
      ...
      annotations: {
        ...
        xaxis: [
          {
            x: new Date("14 feb 2013").getTime(),
            borderColor: "#999",
            label: {
              text: "تجمع",
              style: {
  ...
  if (stackedAreaChart) {
    var options = {
      ...
      xaxis: {
        ...
        categories: ["11 دی", "12 دی", "13 دی", "14 دی", "15 دی", "16 دی", "17 دی", "18 دی", "19 دی", "20 دی"],
      },
      yaxis: {
        labels: {
          show: true,
  ...
  if (dataLabelsColumnChart) {
    var options = {
      ...
      xaxis: {
        categories: ["دی", "دی", "دی", "دی", "دی", "دی", "دی", "دی", "دی", "دی", "دی", "دی"],
        position: "bottom",
        axisTicks: {
          show: false,
          color: "#ECEEF2",
      ...
      title: {
        text: "تورم ماهانه در برزیل ، 1404",
        align: "left",
        offsetX: -9,
        style: {
          fontWeight: "500",
  ...
  if (stackedColumnChart) {
    var options = {
      ...
      xaxis: {
        type: "category",
        categories: ["01/1404", "02/1404", "03/1404", "04/1404", "05/1404", "06/1404"],
        axisTicks: {
          show: false,
          color: "#ECEEF2",
        },
  ...
  if (distributedColumnChart) {
    var options = {
      ...
      colors: ["#605DFF", "#796df6", "#00cae3", "#ffb264", "#2ed47e", "#e74c3c", "#26a69a", "#d10ce8"],
      plotOptions: {
        bar: {
          columnWidth: "45%",
          distributed: true,
  ...
  if (multipleYAxisChart) {
    var options = {
      ...
      title: {
        text: "XYZ - تجزیه و تحلیل سهام (1390 - 1399)",
        align: "left",
        offsetX: 110,
        style: {
          fontWeight: "500",
      ...
      xaxis: {
        categories: [2009, 2010, 2011, 1404, 2013, 2014, 2015, 2016],
        axisTicks: {
          show: false,
          color: "#ECEEF2",
        },
  ...
  if (lineAreaChart) {
    var options = {
      ...
      labels: ["مهر 01", "مهر 02", "مهر 03", "مهر 04", "مهر 05", "مهر 06", "مهر 07", "مهر 08", "مهر 09 ", "مهر 10"],
      markers: {
        size: 0,
      },
      yaxis: [
  ...
  if (multipleRadialBarChart) {
    var options = {
      ...
      labels: ["سیب", "پرتقال", "موزهای", "انواع توت ها"],
  ...
  if (customAngleCircleRadialBarChart) {
    var options = {
      ...
      labels: ["کامل", "فعال", "اختصاصی", "در انتظار"],
      legend: {
        show: true,
        offsetY: 0,
        offsetX: -20,
  ...
  if (multipleRadarChart) {
    var options = {
      ...
      xaxis: {
        categories: ["1404", "1404", "1404", "1404", "1404", "1404"],
        labels: {
          style: {
            colors: "#8695AA",
            fontSize: "12px",
  ...
  if (basicPieChart) {
    var options = {
      ...
      labels: [["کامل", "سفارش جدید", "در انتظار"]],
  ...
  if (basicPolarChart) {
    var options = {
      ...
      labels: ["موزهای", "سیب", "انگور", "پاپیا", "ماست", "زغال اخته", "گیلاس", "پرتقال", "آناناس"],
      grid: {
        show: true,
        borderColor: "#ECEEF2",
      },
  ...
  if (monochromePolarChart) {
    var options = {
      ...
      labels: [" A سرخ", " B سرخ", " C سرخ", " D سرخ", " E سرخ"],
      fill: {
        opacity: 1,
      },
      stroke: {
  ...
  if (basicRangeAreaChart) {
    var options = {
      ...
      title: {
        text: "دمای نیویورک (در تمام طول سال)",
        align: "left",
        offsetX: -9,
        style: {
          fontWeight: "500",
